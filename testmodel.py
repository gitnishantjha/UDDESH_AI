...
import numpy as np
import pickle
career = pd.read_csv('C:\\xampp nitish\\htdocs\\INTELLIGENT-CAREER-GUIDANCE-SYSTEM-main\\dataset9000.data', header = None)
#np.dtype('float64')
...
pickle.dump(knn, open('C:\\xampp nitish\\htdocs\\INTELLIGENT-CAREER-GUIDANCE-SYSTEM-main\\careerlast.pkl','wb'))
